...
class __TwigTemplate_4ebe6a5a2914d127cd4be1faaca486d93bb341b1e29f54c284cf7738d1bde2bb extends Twig_Template
{
    private $source;
...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "/opt/lampp/htdocs/INH/vendor/symfony/web-profiler-bundle/Resources/views/Collector/messenger.html.twig");
    }
}
