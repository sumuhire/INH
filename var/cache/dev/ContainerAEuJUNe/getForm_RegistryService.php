...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\UserFormType' => function () {
    return ($this->privates['App\Form\UserFormType'] ?? $this->privates['App\Form\UserFormType'] = new \App\Form\UserFormType());
